...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_intro_inner_html">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
 document.getElementById('demo').innerHTML = 'Hello JavaScript';</div>
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_intro_inner_html_quotes" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>JavaScript Can Change HTML Attributes</h2>
<p>This example changes an HTML image by changing the src (source) attribute of an &lt;img&gt; tag:</p>
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_intro_lightbulb" target="_blank">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_intro_style">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
 ...
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_intro_hide" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;demo&quot;).style.display = "block";<br>or<br>document.getElementById('demo').style.display = 
  'block';</div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_intro_show" target="_blank">Try it Yourself &raquo;</a>
</div>
